...
Products seen in TownHall Amazon order history (Sep 1–23, 2026) that are **not** in the four smoothie
powder preps. Parked here until their recipe lands, then moved to the right category folder.

Several look like cocktail / syrup / bar prep; a few look like the smoothie **build** step (the
powder slides are labeled "Pt. 3", so Pt. 1 and Pt. 2 likely cover the liquid base and build).
Grouping below is a **guess** — correct it as recipes come in.

## Likely cocktail / bar prep

| Product | Unit size | Price | Qty seen | Notes |
|---|---|---|---|---|
| Blue Green Organics Raw Blue Agave Syrup | 176 oz bulk | $45.59 | 2 | Low-glycemic sweetener; syrup base |
| Simply Organic Vanilla Bean Paste | 4 oz jar | $17.89 | 10 | High qty — likely a syrup or batch component |
| Bhakti Chai Tea Concentrate, Unsweetened | 16 srv, pack of 2 | $19.99 | 6 | |
| Davidson's Tea Bulk, Classic Chai | 16 oz bag | $19.12 | 6 | Loose leaf — steeped, not concentrate |
| Organic Hibiscus Flowers | 2 lb (907 g) | $27.51 | — | Cut & sifted, caffeine free |
...
| Product | Unit size | Price | Notes |
|---|---|---|---|
| Orgain Hydrolyzed Collagen Peptides, Unflavored | 454 g (1 lb) | $21.12 | Purchased Sep 21 alongside the two Keto Collagens, but **no powder prep lists an unflavored collagen**. Either a build-step ingredient or a stand-in for one of the flavored lines. |
